...
const server = new McpServer(
  ...
  },
  {
    instructions: [
      ...
      "target SD/USB/NVMe), updates a running device (`avocado deploy`), or rolls out",
      "to fleet devices (`connect-*`), state what will happen and which target it",
      "affects, and get the user's explicit go-ahead. Read-only actions (searching,",
